          ...
          <div class="col-md-6">
            ...
            <div class="upload-para mt-2">
              <p class="font-14 fw-400">
                You Image dimensions must be at least 800px x 600px in size.
                Also the image size should be a maximum of 2MB, Please resize your file accordingly before you upload.
              </p>
            </div>
